...
static const _EscMsg_type_support_symbol_names_t _EscMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aerobot_interfaces, msg, EscMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aerobot_interfaces, msg, EscMsg)),
  }
};
...
{
  return &::aerobot_interfaces::msg::rosidl_typesupport_cpp::EscMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aerobot_interfaces, msg, EscMsg)() {
  return get_message_type_support_handle<aerobot_interfaces::msg::EscMsg>();
}
