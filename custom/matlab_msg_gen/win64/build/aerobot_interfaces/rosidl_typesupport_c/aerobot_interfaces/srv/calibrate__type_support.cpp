...
#include "aerobot_interfaces/srv/detail/calibrate__type_support.h"
...
static const _Calibrate_Request_type_support_symbol_names_t _Calibrate_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aerobot_interfaces, srv, Calibrate_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aerobot_interfaces, srv, Calibrate_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aerobot_interfaces, srv, Calibrate_Request)() {
  return &::aerobot_interfaces::srv::rosidl_typesupport_c::Calibrate_Request_message_type_support_handle;
}
...
static const _Calibrate_Response_type_support_symbol_names_t _Calibrate_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aerobot_interfaces, srv, Calibrate_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aerobot_interfaces, srv, Calibrate_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aerobot_interfaces, srv, Calibrate_Response)() {
  return &::aerobot_interfaces::srv::rosidl_typesupport_c::Calibrate_Response_message_type_support_handle;
}
...
static const _Calibrate_type_support_symbol_names_t _Calibrate_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aerobot_interfaces, srv, Calibrate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aerobot_interfaces, srv, Calibrate)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, aerobot_interfaces, srv, Calibrate)() {
  return &::aerobot_interfaces::srv::rosidl_typesupport_c::Calibrate_service_type_support_handle;
}
