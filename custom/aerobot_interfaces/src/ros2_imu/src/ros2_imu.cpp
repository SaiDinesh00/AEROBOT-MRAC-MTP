...
static void ros2_imu_SystemCore_setup_j(ros_slros2_internal_block_Pub_T *obj)
{
  ...
  static const char_T b_zeroDelimTopic_0[13] = "/esc_command";
...
static void ros2_imu_SystemCore_setup_jy4g(ros_slros2_internal_block_Pub_T *obj)
{
  ...
  Pub_ros2_imu_119__120.createPublisher(&b_zeroDelimTopic[0], qos_profile);
  obj->isSetupComplete = true;
}
...
{
  SL_Bus_aerobot_interfaces_EscMsg rtb_BusAssignment;
  SL_Bus_aerobot_interfaces_EscMsg rtb_BusAssignment1;
  SL_Bus_aerobot_interfaces_EscSrvRequest rtb_BusAssignment1_i;
    ...
    switch (ros2_imu_DW.is_c3_ros2_imu) {
     ...
     case ros2_imu_IN_Command:
      if (!ros2_imu_B.Pitchmotor) {
        ...
        rtb_BusAssignment.pin_number = ros2_imu_P.Constant_Value_p;
        rtb_BusAssignment.pulse_width = ros2_imu_P.Constant1_Value +
          ros2_imu_P.Constant2_Value;

        // MATLABSystem: '<S8>/SinkBlock'
        Pub_ros2_imu_41__183.publish(&rtb_BusAssignment);
    ...
    switch (ros2_imu_DW.is_c1_ros2_imu) {
     case ros2_imu_IN_ARM1:
      if (ros2_imu_DW.y2 == 1.0) {
        ...
        rtb_BusAssignment1_i.pin_number = ros2_imu_P.Constant1_Value_o;
        rtb_BusAssignment1_i.state = ros2_imu_P.Constant2_Value_a;
        ...
        if (serverAvailableOnTime) {
          ServCall_ros2_imu_119__135.call(&rtb_BusAssignment1_i, &b_varargout_1);
        }
     ...
     case ros2_imu_IN_Command1:
      if (!ros2_imu_B.YawMotor) {
        ...
        rtb_BusAssignment1_i.pin_number = ros2_imu_P.Constant_Value_pf;
        rtb_BusAssignment1_i.state = ros2_imu_P.Constant1_Value_j;
        ...
        if (serverAvailableOnTime) {
          ServCall_ros2_imu_119__126.call(&rtb_BusAssignment1_i, &b_varargout_1);
        }
        ...
        rtb_BusAssignment1.pin_number = ros2_imu_P.Constant_Value_l;
        rtb_BusAssignment1.pulse_width = ros2_imu_P.Constant1_Value_c +
          ros2_imu_P.Constant2_Value_g;

        // MATLABSystem: '<S17>/SinkBlock'
        Pub_ros2_imu_119__120.publish(&rtb_BusAssignment1);
...
void ros2_imu_initialize(void)
{
  ...
  // External mode info
  ros2_imu_M->Sizes.checksums[0] = (2683580736U);
  ros2_imu_M->Sizes.checksums[1] = (1906994599U);
  ros2_imu_M->Sizes.checksums[2] = (523727251U);
  ros2_imu_M->Sizes.checksums[3] = (137577447U);

  {
    ...
    systemRan[19] = (sysRanDType *)&ros2_imu_DW.EnabledSubsystem_SubsysRanBC;
